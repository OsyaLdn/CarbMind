          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">💾 Зберегти страву</h5>
                <button
                  type="button"
                  className="btn-close"
              ...
              <div className="modal-body">
                <div className="mb-3">
                  <label className="form-label fw-bold">Назва заготовки *</label>
                  <input
                    type="text"
                ...
                <div className="alert alert-info py-2 small">
                  <strong>ℹ️ Підказка:</strong> Ця заготовка буде доступна як інгредієнт для інших страв!
                  <div className="mt-2">
